---
slug: /
description: This guide is intended as a reference for those curious to learn more about how to best integrate Arweave GraphQL endpoints into their workflows.
...
1. Feel free to dive into [writing your first query](getting-started), or take a look through [the different kind of queries](queries) available to you.
2. If you're looking to deepen your knowledge, there are a number of [concepts](concepts) worth familiarizing yourself with, e.g. [query anatomy](concepts/query-anatomy) and [pagination](concepts/pagination).
3. Already know what you're doing? Perhaps all you need is a handy reference for [transaction fields](resources/transaction-fields), [block fields](resources/block-fields), or the [full schema](resources/schema).
4. If you're looking to learn more about the basics of building on Arweave, we recommend [starting here](https://arwiki.arweave.dev/#/en/creating-a-dapp-01).
