...
In our case, Arweave nodes are responsible for ingesting and replicating blocks, each block comprising 1+ transactions. Importantly, metadata is embedded alongside each and every block/transaction.
...
All of this is indispensable on the way to answering critical questions while developing such as:
...
- How much did the last ten transactions cost this user?
...
If you're looking to learn more about the basics of building on Arweave, better to [start here](https://arwiki.arweave.dev/#/en/creating-a-dapp-01).
