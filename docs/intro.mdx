...
Feel free to dive into [writing your first query](getting-started), or take a look through [the different kind of queries](queries) GraphQL enables.

If you already know what you're doing, there are handy references for [transaction fields](resources/transaction-fields), [block fields](resources/block-fields), and the [full schema](resources/schema).
